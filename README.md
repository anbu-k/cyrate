...
```
cd existing_repo
git remote add origin https://git.las.iastate.edu/cs309/fall2022/2_jk_4.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.las.iastate.edu/cs309/fall2022/2_jk_4/-/settings/integrations)
...
For incoming students new to Ames, they have no idea what to do or how to explore a new city. CyRate tackles this by creating 
a dedicated tool to view the most popular spots whether it be for dining, shopping, or things to do on a night out. Here, 
students can view reviews from fellow students, get directions, and leave their own take on their experiences.

Individual places can be searched, viewed, and reviewed. Dining locations can get a view of the current menu. Each location 
should have imported photos of the outside and inside interior. Ability to view directions and street view of the location. 
Users should be able to create their own account and favorite their top locations. If time allows, favorite locations can 
be pinned to the home screen as some sort of quick access widget. User types will include Admin, Business Owners, and
normal users. Admin users will be able to add/remove locations. Business Owners will be able to post announcements about 
their business. Normal users will be able to view popular locations and reviews, rate, and review.
